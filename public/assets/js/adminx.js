        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            Array.from(e).forEach(function (e) {
                e.addEventListener("click", function (e) {
                    document
                        .querySelectorAll(".adminx-sidebar")[0]
                        .classList.toggle("in");
                });
            });
                ...
                e.addEventListener("change", function (t) {
                    n(e, e.checked),
                        0 ===
                            ...
                            })(e.closest("table").querySelectorAll(i)).length &&
                            Array.from(
                                e.closest("table").querySelectorAll(o)
                            ).forEach(function (e) {
                                (e.checked = !0),
                                    e.classList.add("all-selected");
                            });
                });
            });
            ...
            Array.from(r).forEach(function (e) {
                e.addEventListener("change", function (t) {
                    ...
                    e.checked
                        ...
                        : (e.classList.remove("all-selected"),
                          Array.from(o).forEach(function (e) {
                              n(e, !1);
                          }));
                });
                ...
                function e(t) {
                    ...
                    document.body.appendChild(
                        this.getElementFromString(
                            '<div id="' +
                                n +
                                '" class="notifications notifications-position-top"></div>'
                        )
                    ),
                        (this.container.top = document.getElementById(n));
                    var o = this.randomID();
                    document.body.appendChild(
                        this.getElementFromString(
                            '<div id="' +
                                o +
                                '" class="notifications notifications-position-bottom"></div>'
                        )
                    ),
                        (this.container.bottom = document.getElementById(o));
                    var i = this.randomID();
                    document.body.appendChild(
                        this.getElementFromString(
                            '<audio preload="auto" volume="' +
                                this.options.volume +
                                '" id="' +
                                i +
                                '">\n          <source src=' +
                                this.options.notificationSound +
                                ' type="audio/mpeg" />\n          <embed hidden="true" loop="false" src="' +
                                this.options.notificationSound +
                                '" />\n        </audio>'
                        )
                    ),
                        (this.player = document.getElementById(i)),
                        this.player.load(),
                        ...
                        },
                        {
                            ...
                            value: function (e, t) {
                                ...
                                !0 === n.playSound &&
                                    ...
                                    this.player.play());
                                var i = this.container[n.position].appendChild(
                                    this.getElementFromString(
